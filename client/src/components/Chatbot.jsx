...
const Chatbot = () => {
  const findResponse = (message) => {
    ...
    for (const intent of intents.intents) {
      ...
      const matchFound = intent.patterns.some((pattern) =>
    ...
    return "I'm sorry, I can only answer questions related to the college. Try asking about admissions, courses, facilities, or placements.";
  };

  const steps = [
    {
      id: "1",
      message: "Hello! Welcome to the college chatbot. How can I help you today?",
      trigger: "userInput",
    },
    {
      id: "userInput",
    ...
    {
      id: "botResponse",
      message: (props) => findResponse(props.steps.userInput.value),
      trigger: "userInput",
    },
  ];
