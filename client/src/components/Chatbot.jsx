...
const ChatbotCombined = () => {
  ...
  useEffect(() => {
    ...
    const loadVoices = () => {
      ...
      if (voices.length > 0) {
        // Try to find a voice with "samantha" or "female" in its name.
        const selectedVoice =
          voices.find((voice) =>
    ...
    loadVoices();
    // Also listen for the voiceschanged event if available.
    window.speechSynthesis.onvoiceschanged = loadVoices;
  }, []);

  const steps = [
    // Welcome and choice to introduce or ask a question
    {
      id: "welcome",
      message:
    ...
    // Service choice: either choose from options or type a free query
    {
      id: "serviceChoice",
      options: [
        {
    ...
    // Options for predefined intents
    {
      id: "intentOptions",
      ...
      <ChatBot
        ...
        speechSynthesis={{
         ...
         // voiceAssistant: { backgroundColor: theme.botBubbleColor },
          ...
          lang: "en",
          voice: femaleVoice,
        }} // Enable speech synthesis with the selected female voice
        botDelay={1000}
        userDelay={1000}
        customStyle={{
